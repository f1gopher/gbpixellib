...
func createOpcodesTable() [256]opcode {
	...
	// ADD SP,n
	opcodes = append(opcodes, createADD_SP_n(0xE8))
...
func createCBOpcodesTable() [256]opcode {
	...
	// RLC
	opcodes = append(opcodes, createCB_RLC_r(0x00, B))
	opcodes = append(opcodes, createCB_RLC_r(0x01, C))
	opcodes = append(opcodes, createCB_RLC_r(0x02, D))
	opcodes = append(opcodes, createCB_RLC_r(0x03, E))
	opcodes = append(opcodes, createCB_RLC_r(0x04, H))
	opcodes = append(opcodes, createCB_RLC_r(0x05, L))
	opcodes = append(opcodes, createCB_RLC_abs_HL(0x06))
	opcodes = append(opcodes, createCB_RLC_r(0x07, A))

	// RRC
	opcodes = append(opcodes, createCB_RRC_r(0x08, B))
	opcodes = append(opcodes, createCB_RRC_r(0x09, C))
	opcodes = append(opcodes, createCB_RRC_r(0x0A, D))
	opcodes = append(opcodes, createCB_RRC_r(0x0B, E))
	opcodes = append(opcodes, createCB_RRC_r(0x0C, H))
	opcodes = append(opcodes, createCB_RRC_r(0x0D, L))
	opcodes = append(opcodes, createCB_RRC_abs_HL(0x0E))
	opcodes = append(opcodes, createCB_RRC_r(0x0F, A))
	...
	opcodes = append(opcodes, createCB_RL_abs_HL(0x16))
	...
	opcodes = append(opcodes, createCB_RR_abs_HL(0x1E))
	...
	opcodes = append(opcodes, createCB_SLA_abs_HL(0x26))
	opcodes = append(opcodes, createCB_SLA_r(0x27, A))

	// SRA
	opcodes = append(opcodes, createCB_SRA_r(0x28, B))
	opcodes = append(opcodes, createCB_SRA_r(0x29, C))
	opcodes = append(opcodes, createCB_SRA_r(0x2A, D))
	opcodes = append(opcodes, createCB_SRA_r(0x2B, E))
	opcodes = append(opcodes, createCB_SRA_r(0x2C, H))
	opcodes = append(opcodes, createCB_SRA_r(0x2D, L))
	opcodes = append(opcodes, createCB_SRA_abs_HL(0x2E))
	opcodes = append(opcodes, createCB_SRA_r(0x2F, A))
	...
	opcodes = append(opcodes, createCB_SWAP_abs_HL(0x36))
	...
	opcodes = append(opcodes, createCB_SRL_abs_HL(0x3E))
	...
	// SET b,r
	opcodes = append(opcodes, createCB_SET_b_r(0xC0, 0, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xC1, 0, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xC2, 0, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xC3, 0, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xC4, 0, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xC5, 0, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xC6, 0))
	opcodes = append(opcodes, createCB_SET_b_r(0xC7, 0, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xC8, 1, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xC9, 1, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xCA, 1, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xCB, 1, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xCC, 1, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xCD, 1, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xCE, 1))
	opcodes = append(opcodes, createCB_SET_b_r(0xCF, 1, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xD0, 2, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xD1, 2, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xD2, 2, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xD3, 2, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xD4, 2, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xD5, 2, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xD6, 2))
	opcodes = append(opcodes, createCB_SET_b_r(0xD7, 2, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xD8, 3, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xD9, 3, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xDA, 3, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xDB, 3, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xDC, 3, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xDD, 3, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xDE, 3))
	opcodes = append(opcodes, createCB_SET_b_r(0xDF, 3, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xE0, 4, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xE1, 4, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xE2, 4, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xE3, 4, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xE4, 4, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xE5, 4, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xE6, 4))
	opcodes = append(opcodes, createCB_SET_b_r(0xE7, 4, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xE8, 5, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xE9, 5, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xEA, 5, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xEB, 5, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xEC, 5, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xED, 5, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xEE, 5))
	opcodes = append(opcodes, createCB_SET_b_r(0xEF, 5, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xF0, 6, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xF1, 6, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xF2, 6, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xF3, 6, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xF4, 6, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xF5, 6, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xF6, 6))
	opcodes = append(opcodes, createCB_SET_b_r(0xF7, 6, A))

	opcodes = append(opcodes, createCB_SET_b_r(0xF8, 7, B))
	opcodes = append(opcodes, createCB_SET_b_r(0xF9, 7, C))
	opcodes = append(opcodes, createCB_SET_b_r(0xFA, 7, D))
	opcodes = append(opcodes, createCB_SET_b_r(0xFB, 7, E))
	opcodes = append(opcodes, createCB_SET_b_r(0xFC, 7, H))
	opcodes = append(opcodes, createCB_SET_b_r(0xFD, 7, L))
	opcodes = append(opcodes, createCB_SET_b_HL(0xFE, 7))
	opcodes = append(opcodes, createCB_SET_b_r(0xFF, 7, A))
