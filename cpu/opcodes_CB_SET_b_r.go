...
func createCB_SET_b_r(opcode uint8, bit uint8, reg Register) *opcode_CB_SET_b_r {
	return &opcode_CB_SET_b_r{
		opcodeBase: opcodeBase{
			opcodeId:     opcode,
			opcodeName:   fmt.Sprintf("SET %d,%s", bit, reg.String()),
